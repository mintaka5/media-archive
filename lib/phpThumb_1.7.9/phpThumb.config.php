...
$appConfig = dirname(dirname(dirname(__FILE__)."..")."..").DIRECTORY_SEPARATOR."config.php";
if(is_file($appConfig)) {
    //var_dump($appConfig); die();
    require_once $appConfig;
} else {
    die("Cannot find app's configuration file.");
}
...
//$PHPTHUMB_CONFIG['cache_directory'] = APP_PATH.'cache' . DIRECTORY_SEPARATOR;
$PHPTHUMB_CONFIG['cache_directory'] = APP_CACHE_PATH . DIRECTORY_SEPARATOR;
...
//$PHPTHUMB_CONFIG['cache_source_directory'] = APP_PATH.'cache/source';
$PHPTHUMB_CONFIG['cache_source_directory'] = APP_CACHE_PATH . DIRECTORY_SEPARATOR . "source";
...
if (strtoupper(substr(PHP_OS, 0, 3)) == 'WIN') {
	...
	//$PHPTHUMB_CONFIG['imagemagick_path'] = '/opt/local/bin/convert';
	$PHPTHUMB_CONFIG['imagemagick_path'] = APP_IMAGEMAGICK_PATH . DIRECTORY_SEPARATOR . 'convert';
...
$PHPTHUMB_CONFIG['ttf_directory'] = APP_PATH . "lib/phpThumb_1.7.9/fonts/";
...
$PHPTHUMB_CONFIG['mysql_query'] = "SELECT filename FROM assets WHERE public_id='" . mysql_escape_string(@$_GET['id']) . "'";
...
$PHPTHUMB_CONFIG['mysql_hostname'] = APP_DB_HOST_SPEC;
$PHPTHUMB_CONFIG['mysql_username'] = APP_DB_USER;
$PHPTHUMB_CONFIG['mysql_password'] = APP_DB_PASSWD;
$PHPTHUMB_CONFIG['mysql_database'] = APP_DB_NAME;
